...
col_widths = {"A":20,"B":28,"C":8,"D":16,"E":10,"F":18,
              "G":30,"H":25,"I":22,"J":50,"K":35,"L":45,"M":45}
...
game_rows = [
    ...
    },
    {
        ...
        "content":"Dao-punk sci-fi blending Taoism + biopunk; story praised as best in genre. 'Best narrative in a metroidvania I have played' -- Steam; 95% positive 35K reviews",
        "replayability":"Moderate -- True Ending requires full exploration; alternate combat styles; high positive rating across large review base",
    },
    {
        ...
        "content":"'A second larger game hidden within the first' -- dev; community solved meta-puzzles months post-launch. 'Still finding new secrets at 100 hours' -- Reddit r/AnimalWell; 95% positive",
        "replayability":"Very high -- community ARG puzzle hunting, multiple secret layers, speedrunning. Solo dev at $24.99 = the benchmark for solo metroidvania commercial success",
    },
    {
        ...
        "content":"Rich Catholic-horror world; NPCs with full questlines; DLC added. 'Bigger, deeper, better looking than the first' -- critics; 90% positive 18K reviews",
    ...
    },
    {
        ...
        "content":"Dark world with rich environmental storytelling; 'An incredible follow-up' -- reviewers; 97-98% positive across ~18K reviews",
    ...
    },
    {
        ...
        "trailer":"Movement showcase first -- somersaults, wall-runs, aerial combos in opening 10s; no explanation; very short; $5.99 price shown",
        ...
        "feature":"3D platformer-metroidvania hybrid; open-ended Castle Sansa exploration; movement ability unlocks change traversal; solo dev; $5.99 price point",
        "scope":"Short -- 3-6 hrs for completion; focus is movement mastery over length",
        "content":"'Best movement in any metroidvania' -- Reddit r/metroidvania; 97% positive. Solo dev at $5.99 earning $4.2M gross = strong case for movement-first niche positioning",
        "replayability":"Very high -- movement routing, speedrunning community, alternate paths. Self-taught solo dev sold 200K+ copies, floored by reception",
    },
    {
    ...
    },
    {
        ...
        "content":"'Spirit over substance' -- Game Informer. Personal grief narrative praised; combat criticized as thin. Surgent faced layoffs post-launch. EA publishing + layoffs = Very Positive reviews but commercial failure",
    ...
    },
    {
        ...
        "content":"96% positive but very small addressable market -- niche positioning caps revenue. 'Exactly what it promises for fans of the aesthetic' -- enthusiast community",
    ...
    },
    {
        ...
        "feature":"Time-loop mechanic; plant-growing progression system; alien cosmic world; non-combat progression options; artistic collaboration",
        "scope":"~10-15 hrs; rich explorable world",
        "content":"'A drop-dead gorgeous head trip' -- GamesRadar; 79% positive. Art-first at cost of gameplay clarity. Audience loved visuals, found gameplay unfocused",
        "replayability":"Moderate -- time-loop discovery, cosmic secrets; art-driven exploration",
    },
    {
        ...
        "content":"'Low cost, well done -- controls are tight, upgrades constant' -- Steam; 93% positive ~403 reviews. Good game that stayed under the radar in a crowded genre window",
    ...
    },
    {
        ...
        "content":"81% positive; criticized for unconventional lock-on and contact damage during flight. Niche audience ceiling. 'Punishing and unfair in the wrong ways' -- some reviewers",
        "replayability":"Moderate -- roguelike randomization adds variety; constrained by small discovery",
    },
    {
        ...
        "content":"Praised for art quality; reception mixed on solo depth. 'Feels thin without friends' -- Steam. Co-op hook underpowered for the promise made at launch",
    ...
    # FAILURE TIER
    {
        ...
        "content":"'Janky experience made for devoted genre fans only' -- reviewer. No tutorial, weak ranged attacks, overpowered bosses. 80% positive (47 reviews) = near-invisible on Steam. QUByte cancelled Xbox port.",
    ...
    },
    {
        ...
        "content":"83% positive but invisible on Steam. PC Gamer cited it as 'quality game few have heard of' alongside Grime II. Launched 2025 into dead genre chart window -- no Metroidvania penetrated Steam weekly charts except Silksong.",
        "replayability":"Low",
    },
    {
        ...
        "scope":"Short",
        "content":"62% positive (Mixed); given away free on Steam in March 2026 -- indicating near-zero commercial value. 'Fine but forgettable' -- community. Demonstrates genre baseline failure: good enough but no identity.",
        "replayability":"Very low",
    },
]

for g in game_rows:
    row = [g["genre"], g["game"], g["year"], g["revenue"], g["review"],
...
snapshot_dir = Path(r"C:\Organized Files\My Game Asset\Game-Research\snapshots") / "metroidvania"
...
high_c = sum(1 for g in game_rows if g["tier"] == "HIGH")
mid_c  = sum(1 for g in game_rows if g["tier"] == "MID")
fail_c = sum(1 for g in game_rows if g["tier"] == "FAILURE")
entry = f"| {today_str} | Metroidvania | {high_c} | {mid_c} | {fail_c} | snapshots/metroidvania/{today_str}.xlsx |\n"
if log_path.exists():
...
print(f"Tiers -- HIGH: {high_c}, MID: {mid_c}, FAILURE: {fail_c}, Total: {len(game_rows)}")
